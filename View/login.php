		...
		<section class="cd-section index visible ">
			<div class="cd-content style1">
				<div class="login-box d-md-flex align-items-center">
					<h1 class="title">Ruang Belajar</h1>
					<h3 class="subtitle">Belajarlah sampai engkau tidak jadi beban negara</h3>
						...
						<div class="login-form-slider">
							...
							<div class="login-slide slide login-style1">
								...
								<div class="sign-up-txt">
									Tidak punya akun? <a href="javascript:;" class="sign-up-click">Daftar</a>
								</div>
							</div>
							<!-- login slide end -->
							<!-- signup slide start -->
								...
								<div class="d-flex height-100-percentage">
									<div class="align-self-center width-100-percentage">
										<form>
											...
											<div class="form-group">
												<label class="label">Ulang Kata Sandi</label>
												<input type="password" class="form-control">
											</div>
										...
										<div class="sign-up-txt">
											if you have an account? <a href="javascript:;" class="login-click">Masuk</a>
										</div>
									</div>
								</div>
							</div>
