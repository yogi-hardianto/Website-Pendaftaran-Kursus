        ...
        <div class="container-fluid mt-3">
            ...
            <div class="container mt-2 col-7">                        
                    ...
                    <div class="form-group row d-flex justify-content-center">
                            <label for="inputNama" class=" font-weight-bolder col-form-label"><h2>Input Guru</h2></label>
                        </div> 
                        <div class="form-group row">
                            <label for="inputNama" class="col-sm-2 col-form-label">Nama Guru</label>
                            <div class="col-sm-10">
                            <input type="nama" class="form-control" id="nama">
                            </div>
                        </div>                        
                        <div class="form-group row">
                            <label for="inputNama" class="col-sm-2 col-form-label">No Telepon</label>
                            <div class="col-sm-10">
